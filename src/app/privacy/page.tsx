  ...
  return (
    <article className="prose mt-8 pb-16 dark:prose-invert">
      ...
      <div className="space-y-4">
        ...
        <p>
          I&apos;ll do my best to keep any info you share safe, but keep in mind—no system is foolproof. While I&apos;ll take reasonable steps
        ...
        <p>
          ...
          an email at{" "}
          <Link href="mailto:priyadarshansaideep@gmail.com">priyadarshansaideep@gmail.com</Link> or use
